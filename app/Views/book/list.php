<div class="container mt-5">
    ...
    <?php if ($_SESSION['RolUser']!='4') {?>
    <button id="BookCreate" data-url="<?= Helpers\generateUrl("Book","Book","viewCreateBook",[],"ajax")?>"
    ...
    <table id="reservationsTable" class="DataTable table table-striped table-bordered">
        ...
        <tbody>
            <?php foreach ($data as $book) {
                // Verificar si el usuario tiene el rol 4 y el libro está inactivo
                if ($_SESSION['RolUser'] == '4' && $book['status'] == 'Inactivo') {
